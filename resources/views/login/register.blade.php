                ...
                <div class="col-md-6">
                    <div class="card">
                        <form method="POST" action="/register" class="box">
                            ...
                            <h1>Register</h1>
                            <p class="text-primary"> Please Fill All Field!</p> 
                            <input type="text" name="name" id="username" placeholder="Username"> 
                            <input type="text" name="email" id="email" placeholder="Email"> 
                            <input type="password" name="password" id="password" placeholder="Password"> 
                            <a class="text-primary" href="/login">Already Have An Account?Login!</a>
                            <input type="submit" value="Register" href="/login"> <!-- Menghapus name="" dari submit button -->
                            <!-- Menghapus href="/login" dari input submit -->
                            <div class="col-md-12">
